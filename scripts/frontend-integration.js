 ...
 * This file demonstrates how to integrate Apexpulse with a web frontend
 */

// For React/Vue/Angular applications
export class ApexpulseClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ApexpulseClient(provider, contractAddress);
